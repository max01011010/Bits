      ...
      <Card className="w-full max-w-md bg-white dark:bg-gray-800 shadow-xl rounded-lg p-6">
        ...
        <CardContent>
          ...
          <Auth
            ...
            providers={[]} // Still no social providers
            theme="light"
            redirectTo={window.location.origin}
            magicLink={authMethod === 'magic_link'} // Enable/disable based on selected method
            view={authMethod === 'magic_link' ? 'magic_link' : 'sign_in'} // Set view based on selected method
            localization={{
              variables: {
                sign_in: {
